...
public class UserRegistration extends JFrame {
    ...
    public UserRegistration() {
        ...
        designation.setFont(new Font("Tahoma", Font.PLAIN, 32));
        designation.setBounds(214, 235, 228, 50);
        ...
        lblAddress.setBounds(542, 245, 99, 24);
        ...
        addrs = new JTextField();
        addrs.setFont(new Font("Tahoma", Font.PLAIN, 32));
        addrs.setBounds(707, 235, 228, 50);
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String designationn = designation.getText();
                String emailId = email.getText();
                String gen = gender.getText();
                String mobileNumber = mob.getText();
                int len = mobileNumber.length();
                String addrss = addrs.getText();
                ...
                try {
                    ...
                    String query = "INSERT INTO account values('" + Name + "','" + designationn + "','" + gen + "','" +
                    		addrss + "','" + emailId + "','" + mobileNumber + "')";
